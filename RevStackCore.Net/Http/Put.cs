...
namespace RevStackCore.Net
{
	public static partial class Http
	{
		...
		public async static Task<ResponseType<T>> PutResponseTypedAsync<T>(string url, T entity)
		{
			...
			{
				return new ResponseType<T>(default(T), InternalServerError);
			}
		}
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json)
		{
			try
			{
		...
		/// <param name="password">Password.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, string username, string password)
		{
			try
			{
		...
		/// <param name="token">Token.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, string token)
		{
			try
			{
		...
		/// <param name="cookie">Cookie.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync<T>(string url, string json, Cookie cookie)
		{
			try
			{
		...
		/// <param name="expDate">ExpDate</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync<T>(string url, string json, object cookies, DateTime? expDate)
		{
			try
			{
		...
		/// <param name="header">Header.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, RequestHeader header)
		{
			try
			{
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, object headers)
		{
            try
            {
		...
		/// <param name="headers">Headers Anonymous Object</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, string token, object headers)
		{
			try
			{
		...
		/// <param name="headers">Headers Anonymous Object</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public async static Task<ResponseType<string>> PutStringAsync(string url, string json, string username, string password, object headers)
		{
			try
			{
